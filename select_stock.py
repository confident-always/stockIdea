...
def main():
    ...
    for cfg in selector_cfgs:
        ...
        # 特殊处理：若为 ADXSelector，则从配置中读取参数并生成对应 CSV
        if cfg.get("class") == "ADXSelector":
            # 从配置中读取dmi_period参数，如果没有则尝试period参数，最后默认为39
            dmi_period = cfg.get("params", {}).get("dmi_period") or cfg.get("params", {}).get("period", 39)
